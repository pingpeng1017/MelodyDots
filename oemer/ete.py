...
#     #pickle.dump(staff_symbols_map,"C:\\test\\staff_symbols.pkl")
...
#     #cv2.imwrite("c:\\test\\symbols.bmp",symbols)
#     #cv2.imwrite("c:\\test\\staff.bmp",staff)
#     cv2.imwrite("c:\\test\\ori.bmp",image)
...
#     mxl_path = extract("C:/Users/Minjoo Lee/MelodyDots/docs/images/___page-0001.jpg", True, True) # 이미지에서 악보 추출하여 MusicXML 생성 및 반환
